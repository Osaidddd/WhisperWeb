...
using WhisperWeb.Server.Data.Entities;
using Whisper.Server;
using WhisperWeb.Server.Hubs;

namespace WhisperWeb.Server.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        private readonly IHubContext<WhisperWebHub, IWhisperWebHubClient> _hubContext;

        public AccountController(ChatContext chatContext, TokenService tokenService, IHubContext<WhisperWebHub, IWhisperWebHubClient> hubContext)
        {
        ...
        public async Task<IActionResult> Register(RegisterDto dto, CancellationToken cancellationToken)
        {
            ...
            var user = new User
            {
                ...
                Name = dto.Name,
                Password = dto.Password, //implement later a password mechanism.
            };
        ...
        public async Task<IActionResult> Login(LoginDto dto, CancellationToken cancellationToken)
        {
            var user = await _chatContext.Users
                                .FirstOrDefaultAsync(u=> u.Username == dto.Username && u.Password == dto.Password, cancellationToken);
            if (user is null)
            {
